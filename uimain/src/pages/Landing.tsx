...
>
  ...
  />
        ...
        <div className="space-y-8">
            ...
            >
              <a href="/dashboard" className="border border-purple-500 hover:bg-purple-500/10 px-8 py-3 rounded-full transition-all transform hover:scale-105">Get Started</a>
